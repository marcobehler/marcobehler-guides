...
Then, instead of endlessly creating Pod manifests, you'd use Kubernete's `_ReplicaSets_`.
...
How many repliaces? What is the selector?
what is the template? saying what docker container is being started...
reconcilliation loop..constantly checking what's up ..do i need to scale up or down?
...
Problem: Auto scaling etc...multiple pods
