...
Make no mistake about it. Those four 101-sections above will (hopefully) give you enough of a mental model to get started with Kubernetes.

On the other hand, you might want to enter "Kubernetes" on https://learning.oreilly.com . You'll get thousands of results, with many many many of the books being 500+ pages long. Fine reading for a rainy winter day! The good thing: you, as a developer, don't have to worry about most of what's written in those books (though being aware of the sheer setup complexity definitely helps)

=== Wait, we haven't talked about YAML yet?
